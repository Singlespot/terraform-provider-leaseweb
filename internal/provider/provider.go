...
func (p *leasewebProvider) Resources(_ context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		publiccloud.NewTargetGroupTargetsResource,
		publiccloud.NewAutoScalingGroupResource,
		publiccloud.NewAutoScalingGroupTargetGroupResource,
		publiccloud.NewSecurityGroupResource,
		publiccloud.NewSecurityGroupRulesResource,
		publiccloud.NewInstanceSecurityGroupsResource,
